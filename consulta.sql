SELECT m.model, 
	...
	JOIN carolina_graciolli_siqueira.colors cAS l ON c.id_color = cl.id_color
	JOIN carolina_graciolli_siqueira.insurances AS i ON i.id_car = c.id_car
	JOIN carolina_graciolli_siqueira.insurance_companies iAS c ON i.id_insurance_company = ic.id_insurance_company
